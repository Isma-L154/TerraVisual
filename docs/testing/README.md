...
| Browser tests | `web/e2e` | Accessibility, the keyboard journey, the diagram's geometry (nothing drawn on top of anything else) and camera, importing, examples, editing, files, image export, the splitter, and the performance budgets — against the real build behind the real CSP |
